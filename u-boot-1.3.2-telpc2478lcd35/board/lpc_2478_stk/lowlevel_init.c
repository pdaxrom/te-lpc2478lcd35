...
//  SCS     |= 0x00000002;
  ...
  EMC_DYN_RAS    = 2;   //>45ns = 3 clk
  EMC_DYN_SREX   = 3;   //>80-100ns = 4 clk
  EMC_DYN_APR    = 1;   //
  EMC_DYN_DAL    = 3+2;   //2 clk
  EMC_DYN_WR     = 3;   //2 clk
  EMC_DYN_RC     = 3;   //>65ns = 4 clk
  EMC_DYN_RFC    = 3;   //>80-100ns = 4 clk
  EMC_DYN_XSR    = 3;   //>80-100ns = 4 clk
  EMC_DYN_RRD    = 0;   //>15ns = 1-2 clk
  EMC_DYN_MRD    = 3;   //2 clk
  ...
  EMC_DYN_RP     = 1;   //>20ns = 2 clk
  EMC_DYN_RAS    = 2;   //>45ns = 3 clk
  EMC_DYN_SREX   = 3;   //>80-100ns = 5 clk
  EMC_DYN_APR    = 1;   //
  EMC_DYN_DAL    = 5;   //2 clk
  EMC_DYN_WR     = 3;   //2 clk
  EMC_DYN_RC     = 3;   //>65ns = 4 clk
  EMC_DYN_RFC    = 3;   //>80-100ns = 6 clk
  EMC_DYN_XSR    = 3;   //>80-100ns = 6 clk
  EMC_DYN_RRD    = 0;   //>15ns = 1-2 clk
  EMC_DYN_MRD    = 3;   //2 clk
  EMC_DYN_RD_CFG = 1;   //or 1,2,3
  ...
  //EMC_DYN_RFSH = 28;		//--ivan
  EMC_DYN_RFSH = 7813/16;	//--stanimir
...
#ifdef USE_32_BIT_DATABUS
  dummy = *((volatile unsigned int*)(SDRAM_BASE_ADDR | (0x32 << 13)));
#else
