...
#define	CFG_PROMPT		"lpc-e2468 # " /* Monitor Command Prompt	*/
...
#define CFG_MEMTEST_END		0xA0F80000	/* 31.5 MB in DRAM	*/
...
#define PHYS_SDRAM_1_SIZE	0x01000000 /* 32 MB SDRAM */
...
/* USB OHCI dual host controllers */
...
#define	CFG_USB_OHCI_SLOT_NAME	"lpc-e2468"
#define	CFG_USB_OHCI_MAX_ROOT_PORTS	15 // ??? 
#define CFG_USB_OHCI_HCCA_BASE	0x7fd00000 /* the USB bus master has to use this 
...
#define CONFIG_EXTRA_ENV_SETTINGS \
          "tftp_boot=tftpboot 0xa0008000 linux.bin;tftpboot 0xa0800000 romfs.bin;go 0xa0008000\0" \
          "nand_boot=nand read 0xa0008000 0x0 0x220000;nand read 0xa0800000 0x400000 0x220000;go 0xa0008000\0" \
          "mmc_boot=mmcinit;fatload mmc 0x0 0xa0008000 linux.bin;fatload mmc 0x0 0xa0800000 romfs.bin;go 0xa0008000\0" \
          "update_uboot=tftpboot 0xa0000000 u-boot.bin;protect off 0x0 0x2ffff;erase 0x0 0x2ffff;cp.b 0xa0000000 0x0 $(filesize)\0" \
          "update_nand=nand erase;tftpboot 0xa0000000 linux.bin;nand write 0xa0000000 0x0 0x220000;tftpboot 0xa0000000 romfs.bin;nand write oxa0000000 0x400000 0x220000\0" \
          "ipaddr=192.168.0.157\0" \
          "netmask=255.255.255.0\0" \
          "serverip=192.168.0.240\0" \
          "ethaddr=00:de:ad:b0:05:02\0"
